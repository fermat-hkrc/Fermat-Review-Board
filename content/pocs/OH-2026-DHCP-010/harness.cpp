// Include the production translation unit so the exercised function and its
// return-value check are exactly the repository implementation.  build.sh adds
// the production source directory to the include path.
#include "dhcp_s_server.cpp"

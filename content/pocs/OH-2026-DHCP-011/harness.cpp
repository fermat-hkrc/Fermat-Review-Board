...
// build.sh adds the production header and source directories to the include
// path.  This preserves the production DhcpDecline body in the test binary.
#define private public
#include "dhcp_client_state_machine.h"
#undef private

#include "dhcp_client_state_machine.cpp"

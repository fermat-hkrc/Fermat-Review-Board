// Calls production proxy and production server stub through a minimal in-process
// Lite IPC transport.  The server's StartDhcpClient implementation records any
